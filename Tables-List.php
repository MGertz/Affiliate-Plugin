...
function my_row_actions($id=0) {
	...
	$page = "?page=Affiliate-Plugin/Tables/";
...
?>
<div class="wrap">
	<h2>Pristabeller <a href="?page=Affiliate-Plugin/Tables/Add" class="add-new-h2">Tilf&oslash;j Ny</a></h2>

	<div class="AP_Left">

	<p>Liste over alle pristabeller</p>
